...
const faqs = [
  ...
  },
  {
    ...
    answer: "Да. Работим с оригинални тестери в оригинални опаковки – същият аромат от съответната марка."
  },
  {
    question: "Какво означава тестер?",
    answer: "Тестерът е оригинален парфюм от производителя, в оригинална опаковка. Ароматът е същият като при стандартната бутилка."
  },
  {
