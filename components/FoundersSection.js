...
const founders = [
  {
    name: "Антон Алмишев",
    phone: "0877382224",
    bio: "Антон Алмишев е създателят на Flowers Boutique MIA – бутикова цветарница, посветена на това да превръща емоциите в красиви букети и декорации. Той подбира внимателно всяко цвете, всяка кошница и всеки детайл, за да създаде персонални аранжировки за сватби, рождени дни, годишнини, корпоративни събития и уютен дом. Вярва, че правилно подбраният букет може да каже повече от хиляди думи и подхожда към всяка поръчка с лично внимание и усет към стила. Научете повече за нас.",
    initial: "АА",
