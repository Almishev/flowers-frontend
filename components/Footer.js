          ...
          <FooterSection>
            <Logo>
              ...
              <p style={{fontSize: '0.85rem', marginTop: '0'}}>
                Оригинални тестери в оригинални опаковки – класика, грижа и аксесоари.
              </p>
          ...
          <FooterSection>
            ...
            <ContactInfo>
              <div className="contact-item">
                ...
                <span>ул. Серес 12, Гоце Делчев, България, 2900</span>
              </div>
              <div className="contact-item">
                <svg fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="contact-item">
                ...
                <span>danieladelieva1985@gmail.com</span>
              </div>
            </ContactInfo>
          </FooterSection>
        </FooterContent>
