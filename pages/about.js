...
export default function AboutPage() {
  ...
  return (
    <>
      <SEO 
        title="За нас | DÉLIE – оригинални парфюми"
        description="DÉLIE е бутик за оригинални парфюми. Дамски, мъжки, унисекс, арабски и нишови аромати с доставка в цяла България."
        keywords="DÉLIE, оригинални парфюми, парфюмен бутик, дамски парфюми, мъжки парфюми"
        url="/about"
        ...
        <ContentWrapper>
          <AnimatedSection ref={introAnimation.ref} style={introAnimation.style}>
            ...
            <Paragraph>
              ...
              При нас ще откриете дамски, мъжки, унисекс, арабски и нишови парфюми – оригинални тестери в оригинални опаковки, внимателно подбрани, за да разкажат вашата история.
            </Paragraph>
          </AnimatedSection>
          ...
          <AnimatedSection ref={servicesAnimation.ref} style={servicesAnimation.style}>
            ...
            <ServicesList>
              <li>Оригинални тестери в оригинални опаковки</li>
