...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      <SEO 
        title="Политика за поверителност | DÉLIE"
      ...
      <Center>
        ...
        <ContentWrapper>
          <AnimatedSection ref={introAnimation.ref} style={introAnimation.style}>
            <Paragraph>
              DÉLIE (&quot;ние&quot;, &quot;нас&quot;, &quot;нашата&quot;) уважава вашата поверителност и се ангажира да защитава вашите лични данни. 
              ...
              за парфюми или правите поръчка при нас.
            </Paragraph>
            <InfoBox>
              <Paragraph>
          ...
          <AnimatedSection ref={dataAnimation.ref} style={dataAnimation.style}>
            ...
            <List>
              ...
              <li><strong>Данни за поръчките:</strong> избрани продукти (парфюми), количество, цена, избран метод на плащане и доставка, бележка към поръчката</li>
          ...
          <AnimatedSection ref={usageAnimation.ref} style={usageAnimation.style}>
            ...
            <List>
              <li><strong>Изпълнение на поръчки:</strong> обработка и потвърждаване на поръчки, подготовка на пратките, организиране на доставката</li>
